...
// scan the rep_ data. check the tag in record and use handler to do the right
// operation use GetLengthPrefixedSlice function to get the key value from Slice
